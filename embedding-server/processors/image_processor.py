...
class ImageProcessor:
    ...
    def describe_image(self, image_bytes: BytesIO) -> str:
        ...
        response = self.client.models.generate_content(
            ...
            contents=[
                "Gere um texto incluindo apenas as características físicas deste animal de estimação como a cor da pelagem, raça, e porte, de forma simples, usando apenas 2-3 frases.\n"
